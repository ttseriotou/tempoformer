...
text_pad = padding.pad_np(df.text, df)
...
params['sequential_pooling']= None #'mha_rotary'
...
params['file_name_results'] = 'topicshift_tempoformer_mhaablation-20posts_5fold_seeds_tuning_'
